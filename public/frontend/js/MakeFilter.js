...
function MakeFilter() {
    ...
    if (filter_checked.length > 0) 
    {
        ...
        url = "resources/php/ProductFilter.php?filter_checked[]=" + encodeURIComponent(filter_checked[i]);
        // url = "resources/views/filterproduct.blade.php?filter_checked[]=" + encodeURIComponent(filter_checked[i]);
        i++;
