                            ...
                            <div class="product_card">
                                <div class="product-image">
                                    <img class="product-img"
                                        src="{{ URL::to('public/uploads/product/' . $pro->product_image) }}">
                                </div>
                                <div class="product-content">
                                    <a href="{{ URL::to('/chi-tiet-san-pham/' . $pro->product_id) }}"
                                        class="product-name">{{ $pro->product_name }}</a>
    ...
    <section class="news-category">
        ...
        <div class="news-container">
            <div class="news-container-leftside">
                ...
                <button type="submit" class="see-more-button"
                    onclick="window.location.href='{{ URL::to('/tat-ca-bai-viet') }}'">Xem thêm</button>
            </div>
            <div class="news-container-rightside">
                @foreach ($all_post as $key => $post)
                    {{-- <a href="{{ URL::to('/bai-viet/'.$post->post_slug) }}"> --}}
                    <div class="a-news">
                        <a href="{{ URL::to('/bai-viet/' . $post->post_slug) }}"><img
                                src="{{ asset('public/uploads/post/' . $post->post_image) }}"></a>
                        <a class="post_title"
                            href="{{ URL::to('/bai-viet/' . $post->post_slug) }}">{{ $post->post_title }}</a>
                        <a class="post_desc"
                            href="{{ URL::to('/bai-viet/' . $post->post_slug) }}">{{ $post->post_desc }}</p></a>
                    </div>
                @endforeach
            </div>
        </div>
