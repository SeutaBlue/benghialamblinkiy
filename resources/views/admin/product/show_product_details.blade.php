        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$pro->SL }}</td>
              <td>
                <a href="{{ URL::to('/edit-product-details/'.$pro->product_id) }}" class="active styling-edit" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a><br>
